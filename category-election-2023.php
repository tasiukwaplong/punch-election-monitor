...
<section class="news-highlight-section py-4">
    <div class="container">
        ...
        <div class="row align-items-center bg-light shadow-sm rounded">
            ...
            <!-- Image section -->
            <div class="col-md-4 p-0 border-left border-danger border-lg">
                <a href="<?php the_permalink(); ?>">
                    <?php if (has_post_thumbnail()) : ?>
                        <img src="<?php the_post_thumbnail_url('large'); ?>" alt="<?php the_title_attribute(); ?>" class="img-fluid w-100 h-100 rounded-left">
                    <?php else : ?>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/default.jpg" alt="Default Image" class="img-fluid w-100 h-100 rounded-left">
                    <?php endif; ?>
                </a>
            </div>
            ...
            <div class="col-md-7 p-4">
                ...
                <div class="mt-3">
                    <a href="<?php the_permalink(); ?>" class="btn btn-dark rounded-pill px-4">Read More</a>
                </div>
            </div>
